...
papers = [
    {"title": "Neural Networks in Medicine", "authors": ["Alice", "Bob"], "content": "neural networks and applications"},
    {"title": "Quantum Computing Basics", "authors": ["Carol"], "content": "quantum algorithms"}
]

datasets = [
    {"name": "Medical Imaging Dataset", "domain": "medical", "description": "used for medical imaging"},
    {"name": "Quantum Dataset", "domain": "quantum", "description": "quantum research"}
]

for i, doc in enumerate(papers):
    client.index(index="papers", id=i, body=doc)

for i, doc in enumerate(datasets):
    client.index(index="datasets", id=i, body=doc)
